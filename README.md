...
<div align="center">
  ...
  **Scan a machine → know what's happening → do the work → prove it.**
  ...
  [![Version](https://img.shields.io/badge/Version-3.7.0-brightgreen?style=for-the-badge)](https://github.com/DougTrier/trier-os/releases/tag/v3.7.0)
...
> 4. **Ready to install?** → [Download v3.7.0 from Releases](https://github.com/DougTrier/trier-os/releases/latest) — includes step-by-step PDF
...
Real-device screenshots from an iPhone running Trier OS v3.7.0 over a plant LAN:
...
Current suite: **1491 / 1510 passing — 0 failures** (v3.7.0, verified 2026-04-27)
