...
// Injects Fastenal Facility Maintenance Catalog parts into mfg_master.db.
//
// Usage:
//   node scripts/apply_fastenal_parts.js [--dry-run]
...
if (!fs.existsSync(SQL_PATH)) {
  ...
  console.error('Run: node scripts/extract_fastenal.js first');
  process.exit(1);
}
...
console.log(`\nNext: node scripts/auto_fastenal_lookup.js`);
