...
// Injects MSC Big Book V24 parts into mfg_master.db.
//
// Usage:
//   node scripts/apply_msc_parts.js [--dry-run]
...
if (!fs.existsSync(SQL_PATH)) {
  ...
  console.error('Run: node scripts/extract_msc.js first');
  process.exit(1);
}
...
console.log(`\nNext: node scripts/auto_msc_lookup.js`);
