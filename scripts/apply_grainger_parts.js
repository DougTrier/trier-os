...
// Injects Grainger Catalog 417 parts into mfg_master.db.
//
// Usage:
//   node scripts/apply_grainger_parts.js [--dry-run]
...
if (!fs.existsSync(SQL_PATH)) {
  ...
  console.error('Run: node scripts/extract_grainger.js first');
  process.exit(1);
}
...
console.log(`\nNext: node scripts/auto_grainger_lookup.js`);
