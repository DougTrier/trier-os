            ...
            subsections: [
                {
                    ...
                    items: [
                        ...
                        t('manual.item.1737', 'Current Status: All 13 invariants return overallStatus: PASS as of v3.7.1. This is verified as part of every pre-release checklist.'),
                    ]
                },
                {
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
                            ...
                            <div>
                                ...
                                <p style={{ color: 'var(--text-muted)', fontSize: '0.85rem', margin: 0 }}>{t('about.manualSubtitle', 'Built on 33 Years of Operational Knowledge • Version 3.7.1')}</p>
                            </div>
                        </div>
