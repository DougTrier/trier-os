...
// KPI Card
// ═══════════════════════════════════════════════════════════════════════════
function KPICard({ icon: Icon, label, value, sub, color, trend, trendLabel, onClick }) {
...
// Mini Bar Chart
// ═══════════════════════════════════════════════════════════════════════════
function MiniBarChart({ data, valueKey, labelKey, color, height = 140 }) {
...
// Plant Score Badge
// ═══════════════════════════════════════════════════════════════════════════
function PlantScoreBadge({ score }) {
    const { t } = useTranslation();
...
// ═══════════════════════════════════════════════════════════════════════════
// Plant Spend Table (Sortable)
// ═══════════════════════════════════════════════════════════════════════════
function PlantSpendTable({ plants }) {
    const { t } = useTranslation();
...
// ═══════════════════════════════════════════════════════════════════════════
// Access Manager Panel (Creator Only)
// ═══════════════════════════════════════════════════════════════════════════
function AccessManager({ isCreator }) {
    const { t } = useTranslation();
